...
import com.core.data_04.api.ProductRetreiver
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    //
    val email = "MiamiAutoApp@hotmail.com"
    //-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        val callback = object : Callback<ProductList> {      //  This callback is needed by the Retreiver Class
            ...
            override fun onResponse(call: Call<ProductList>, response: Response<ProductList>) {
                response?.isSuccessful.let {
                    this@MainActivity.photos = response?.body()?.vehicles//  The @ symbol is how you reference your outer Activity in Kotlin - THIS "Products" is the name of the array on the JSON RESOURCE WEB FEED
